<template>
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <img class="mx-auto h-10 w-auto" src="https://fanwave.digital/wp-content/uploads/2020/07/cropped-Logo.png" alt="Your Company" />
        </div>
...
const login = () => {
    axios.post(route('login'), form.value).then(res => location.reload())
}
</script>
